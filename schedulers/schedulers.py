# Taken from Restormer [https://github.com/swz30/Restormer/blob/df766d5521afd21cce56e24159f300b30ebf3fb0/basicsr/models/lr_scheduler.py#L136]
import math
...
def get_scheduler(optimizer, config):
    ...
    Args:
        ...
        config (dict): Scheduler config, which should contain:
            type (str): Scheduler type.
            params (dict): Params for the scheduler.

    Returns:
        torch.optim.lr_scheduler: PyTorch scheduler.
    """
    ...
    if scheduler_type == 'MultiStepLR':
        ...
        return torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, **scheduler_params)
        ...
        return CosineAnnealingRestartCyclicLR(optimizer, **scheduler_params)
    else:
